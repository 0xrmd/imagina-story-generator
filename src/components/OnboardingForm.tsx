...
const OnboardingForm: React.FC<OnboardingFormProps> = ({ className }): JSX.Element => {
  ...
  return (
    <div className={cn("w-full max-w-md mx-auto", className)}>
      <div className="relative overflow-hidden glass-card rounded-2xl p-8 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-white/20 dark:border-slate-700/20 shadow-lg">
